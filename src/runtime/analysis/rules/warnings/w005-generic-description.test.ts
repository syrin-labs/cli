/**
 * Tests for W005: Generic Description rule.
 */
...
describe('W005: Generic Description', () => {
  ...
  it('should warn when tool has generic description', async () => {
    ...
    expect(w005Warnings.length).toBeGreaterThan(0);
    expect(w005Warnings[0]?.tool).toBe('process_data');
  });
