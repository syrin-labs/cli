/**
 * Tests for E106: Output Not Guaranteed rule.
 */
...
describe('E106: Output Not Guaranteed', () => {
  ...
  it('should detect nullable output used downstream without fallback', async () => {
    ...
    const e106Errors = result.errors.filter(e => e.code === 'E106');
    expect(e106Errors.length).toBeGreaterThan(0);
  });
  ...
  it('should pass when nullable output is used with optional input', async () => {
    ...
    const e106Errors = result.errors.filter(e => e.code === 'E106');
    expect(e106Errors).toHaveLength(0);
  });
});
