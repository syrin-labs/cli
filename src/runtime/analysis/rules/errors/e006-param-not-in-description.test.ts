/**
 * Tests for E006: Param Not In Description rule.
 */
...
describe('E006: Param Not In Description', () => {
  ...
  it('should detect required parameter not mentioned in description', async () => {
    ...
    expect(e006Errors[0]?.tool).toBe('get_user');
    expect(e006Errors[0]?.field).toBe('userId');
  });
