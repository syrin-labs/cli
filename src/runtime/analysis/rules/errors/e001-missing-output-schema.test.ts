/**
 * Tests for E001: Missing Output Schema rule.
 */
...
describe('E001: Missing Output Schema', () => {
  ...
  it('should detect tool without output schema', async () => {
    ...
    const normalizedTools = [
      {
        ...
        outputs: [], // No outputs - should trigger E001
    ...
    expect(e001Errors[0]?.tool).toBe('get_user');
